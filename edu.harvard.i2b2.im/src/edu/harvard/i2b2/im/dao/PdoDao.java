...
public class PdoDao  extends JdbcDaoSupport {
	...
	public String getPDO(PdoQryHeaderType requestType, ProjectType projectInfo,
						 PDORequestMessage getFoldersMsg) throws Exception {
	...
	public PidSet findPidsByProject(final PidSet returnType, final String userId,
									final ProjectType projectInfo, final DBInfoType dbInfo) throws Exception {
		...
		for (PidType pidType: returnType.getPid()) {
			...
			String tablesSql = "SELECT distinct m1.lcl_id, m1.lcl_site " +
	...
	public AuditsType getAudit(final GetAuditType auditType, final String userId,
		...
		tablesSql += " 1=1 ORDER BY query_date " +
